...
<select name="status_id" class="form-control">
  ...
  <?php endforeach; ?>
    ...
    <button class="btn btn-primary btn-block">Procesar</button>
		...
		<?php
$users= array();
if((isset($_GET["status_id"]) && isset($_GET["pacient_id"]) && isset($_GET["medic_id"]) && isset($_GET["start_at"]) && isset($_GET["finish_at"]) ) && ($_GET["status_id"]!=""  || $_GET["pacient_id"]!="" || $_GET["medic_id"]!="" || ($_GET["start_at"]!="" && $_GET["finish_at"]!="") ) ) {
...
if($_GET["status_id"]!=""||$_GET["pacient_id"]!="" ||$_GET["medic_id"]!="" ){
	$sql .= " and ";
}
