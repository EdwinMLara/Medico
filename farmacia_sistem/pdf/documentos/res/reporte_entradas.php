...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		...
		<?php
			...
			$cantotal=0;
			$nums=1;
			$query=mysqli_query($con,"SELECT * FROM detalle_productos, medicamentos WHERE detalle_productos.codigo_producto = medicamentos.codigo_medicamento AND detalle_productos.detalle_date_added BETWEEN '$date1' AND '$date2' AND detalle_productos.status='1' ORDER BY detalle_productos.id_detalle_producto DESC");
